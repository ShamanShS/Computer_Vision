...
if __name__ == "__main__":
    ...
    result_image4 = hysteresis(suppressed_image1, 75, 150)
    ...
    plt.subplot(3, 3, 5)
    plt.imshow(gradient_magnitude1, cmap="hsv")
    plt.axis('off')
    plt.title('Магнитуда градиента 1')

    plt.subplot(3, 3, 6)
    plt.imshow(gradient_direction1, cmap="hsv")
    plt.axis('off')
    plt.title('Направление градиента 1')

    plt.subplot(3, 3, 7)
    plt.imshow(quantized_direction1, cmap="hsv")
    plt.axis('off')
